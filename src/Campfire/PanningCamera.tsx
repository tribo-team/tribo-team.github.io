...
export class PanningCamera extends BABYLON.ArcRotateCamera {
  ...
  public override _checkInputs(): void {
    ...
    if (
      ...
      if (this.getScene().useRightHandedSystem) {
        this.alpha -=
          this.beta <= 0 ? -this.inertialAlphaOffset : this.inertialAlphaOffset;
      } else {
        this.alpha +=
          this.beta <= 0 ? -this.inertialAlphaOffset : this.inertialAlphaOffset;
      }
  ...
  private _transformNormalToRefForMapPanning(
    ...
    const x =
      ...
      vector.z * transformation.m[4];
    const y =
      vector.x * transformation.m[1] +
      vector.y * transformation.m[9] +
      vector.z * transformation.m[5];
    const z =
      vector.x * transformation.m[2] +
      vector.y * transformation.m[10] +
      vector.z * transformation.m[6];
